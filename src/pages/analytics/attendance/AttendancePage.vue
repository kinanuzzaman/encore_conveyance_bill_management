    ...
    <main>
        ...
        <section class="mx-4 my-6 flex justify-between">
            ...
            <div class="flex md:gap-x-5 gap-1 justify-items-end">
                ...
                <div> <q-btn outline rounded @click="confirm = true" label="Add request" no-caps />
        ...
        <div class="">
            <section class="">
                <div class="q-px-md gt-sm">
                    ...
                    <q-table flat class="h-[85vh]" :rows="rows" :columns="columns"
                        style="background: rgba(244, 244, 244, 0.8)" :selected-rows-label="getSelectedString"
                        selection="multiple" v-model:selected="selectedItems" row-key="name">
